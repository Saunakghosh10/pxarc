    ...
    <ParallaxProvider>
      <div className="gap-y-36 grid grid-cols-1 md:grid-cols-2 px-6 md:px-10 py-44 min-h-screen">
        <div className="col-span-1">
          <Parallax speed={20}>
            <Link href={PROJECTS[0].url} target="_blank" className="cursor-pointer">
        ...
        <div className="flex justify-end items-center col-span-1">
          <Parallax speed={-10}>
            <Link href={PROJECTS[1].url} target="_blank" className="cursor-pointer">
              <div className="flex flex-col gap-3 w-full md:w-[500px] group">
        ...
        <div className="flex justify-center items-center col-span-1 md:col-span-2">
          <Parallax speed={10}>
            <Link href={PROJECTS[2].url} target="_blank" className="cursor-pointer">
        ...
        <div className="flex items-center col-span-1">
          <Parallax speed={-10}>
            <Link href={PROJECTS[3].url} target="_blank" className="cursor-pointer">
              <div className="flex flex-col gap-3 w-full md:w-[500px] group">
                <div className="rounded-md w-full md:w-[500px] h-[500px] overflow-hidden">
                  <Image
                    src={PROJECTS[3].src}
        ...
        <div className="flex justify-end col-span-1">
          <Parallax speed={20}>
            <Link href={PROJECTS[4].url} target="_blank" className="cursor-pointer">
              <div className="flex flex-col gap-3 w-full md:w-[500px] group">
